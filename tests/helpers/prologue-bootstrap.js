/** @deprecated Frozen Sprint 1 regression composition; never imported by production. */
import { createMetrics } from "../../src/core/domain/meters.js";
import { assertRendererPort } from "../../src/core/ports/renderer-port.js";
import { assertStoragePort } from "../../src/core/ports/storage-port.js";
import { planGameStateTransition } from "../../src/core/state-machine/game-state.js";
import { resolveChoiceTransaction } from "../../src/core/use-cases/choice-transaction.js";
import { PROLOGUE_SLICE, validatePrologueSlice } from "../fixtures/legacy/prologue-slice.js";
import { createLocalStorageAdapter } from "../../src/data/persistence/local-storage-adapter.js";
import {
  CURRENT_SAVE_FORMAT_VERSION,
  validateSaveEnvelope,
} from "../../src/data/validation/save-envelope-validator.js";
