...
- `docs/sprints/sprint-01-master-prompt.md`: แม่แบบ Master Prompt ฉบับสมบูรณ์สำหรับ AI Agent และ Sub-Agents
...
- ผู้ใช้สามารถคัดลอก Master Prompt จาก `docs/sprints/sprint-01-master-prompt.md` หรือในหน้าต่างแชทไปสั่งการ AI Agent ตัวใดก็ได้ที่มีขีดความสามารถ Sub-agents เพื่อเริ่มงานทันที
